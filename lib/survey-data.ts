  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        type: "single",
        options: [
          { icon: "✦", label: "Classic & Clean", sub: "Timeless, refined basics" },
          { icon: "◎", label: "Relaxed & Casual", sub: "Comfort-forward, laid-back" },
          { icon: "▲", label: "Sharp & Polished", sub: "Crisp, intentional" },
          { icon: "◈", label: "Streetwear Influenced", sub: "Urban, graphic-forward" },
        ],
      },
    ],
  },
...
export const PALETTES: PaletteItem[] = [
  ...
  { name: "Deep & Rich", sub: "Burgundy, forest, plum", swatches: ["#3B1A1A", "#1A3B2A", "#4A1A4A", "#7A3030"] },
  { name: "Natural Greens", sub: "Olive, sage, moss", swatches: ["#2A3020", "#4A5C38", "#7A8C60", "#B8C4A0"] },
  { name: "Understated Basics", sub: "Cream, oat, warm white", swatches: ["#FAF7F2", "#F0E8D8", "#E0D4C0", "#C8B898"] },
];
